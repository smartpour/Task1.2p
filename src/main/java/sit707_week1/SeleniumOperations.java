...
public class SeleniumOperations {
	...
	public static void open_chrome_and_close() {
		...
		System.setProperty("webdriver.chrome.driver", "C:\\Users\\ksang\\Downloads\\chromedriver-win64\\chromedriver-win64\\chromedriver.exe");
	...
	public static void open_chrome_loadpage_resize_close() {
	    ...
	    System.out.println("Hello from <s224247523>, <Kartik Sangwan>");
